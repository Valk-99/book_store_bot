    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buyer', models.ForeignKey(on_delete=models.SET(0), to='bookstore.user', verbose_name='Покупатель')),
                ('item_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bookstore.item', verbose_name='Идентификатор Товара')),
            ],
            options={
